...
export default function CallToAction() {
  return (
    <div className="  bg-amber-100 dark:bg-slate-700 flex flex-col sm:flex-row border border-teal-500 justify-center items-center rounded-tl-3xl rounded-br-3xl text-center">
